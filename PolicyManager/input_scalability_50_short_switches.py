...
BROADCAST3_IP = "1.1.3.0/24"
BROADCAST4_IP = "1.1.4.0/24"
BROADCAST5_IP = "1.1.5.0/24"
BROADCAST6_IP = "1.1.6.0/24"
BROADCAST7_IP = "1.1.7.0/24"
BROADCAST8_IP = "1.1.8.0/24"
BROADCAST9_IP = "1.1.9.0/24"
BROADCAST10_IP = "1.1.10.0/24"
BROADCAST11_IP = "1.1.11.0/24"
BROADCAST12_IP = "1.1.12.0/24"
BROADCAST13_IP = "1.1.13.0/24"
BROADCAST14_IP = "1.1.14.0/24"
BROADCAST15_IP = "1.1.15.0/24"
BROADCAST16_IP = "1.1.16.0/24"
BROADCAST17_IP = "1.1.17.0/24"
BROADCAST18_IP = "1.1.18.0/24"
BROADCAST19_IP = "1.1.19.0/24"
BROADCAST20_IP = "1.1.20.0/24"
...
LABELS["Broadcast"] = [BROADCAST_IP]#,BROADCAST2_IP,BROADCAST3_IP,BROADCAST4_IP,BROADCAST5_IP,BROADCAST6_IP,BROADCAST7_IP,BROADCAST8_IP,BROADCAST9_IP,BROADCAST10_IP,BROADCAST11_IP,BROADCAST12_IP,BROADCAST13_IP,BROADCAST14_IP,BROADCAST15_IP,BROADCAST16_IP,BROADCAST17_IP,BROADCAST18_IP,BROADCAST19_IP,BROADCAST20_IP]

"""
LABELS["Broadcast2"] = [BROADCAST2_IP]
LABELS["Broadcast3"] = [BROADCAST3_IP] 
LABELS["Broadcast4"] = [BROADCAST4_IP] 
LABELS["Broadcast5"] = [BROADCAST5_IP] 
LABELS["Broadcast6"] = [BROADCAST6_IP] 
LABELS["Broadcast7"] = [BROADCAST7_IP] 
LABELS["Broadcast8"] = [BROADCAST8_IP] 
LABELS["Broadcast9"] = [BROADCAST9_IP] 
LABELS["Broadcast10"] = [BROADCAST10_IP]
LABELS["Broadcast11"] = [BROADCAST11_IP]
LABELS["Broadcast12"] = [BROADCAST12_IP]
LABELS["Broadcast13"] = [BROADCAST13_IP] 
LABELS["Broadcast14"] = [BROADCAST14_IP] 
LABELS["Broadcast15"] = [BROADCAST15_IP] 
LABELS["Broadcast16"] = [BROADCAST16_IP] 
LABELS["Broadcast17"] = [BROADCAST17_IP] 
LABELS["Broadcast18"] = [BROADCAST18_IP] 
LABELS["Broadcast19"] = [BROADCAST19_IP] 
LABELS["Broadcast20"] = [BROADCAST20_IP] 
"""
...
IP_LOCATIONS[BROADCAST2_IP] = 26
IP_LOCATIONS[BROADCAST3_IP] = 27
IP_LOCATIONS[BROADCAST4_IP] = 28
IP_LOCATIONS[BROADCAST5_IP] = 29
IP_LOCATIONS[BROADCAST6_IP] = 30
IP_LOCATIONS[BROADCAST7_IP] = 31
IP_LOCATIONS[BROADCAST8_IP] = 32
IP_LOCATIONS[BROADCAST9_IP] = 33
IP_LOCATIONS[BROADCAST10_IP] = 34
IP_LOCATIONS[BROADCAST11_IP] = 35
IP_LOCATIONS[BROADCAST12_IP] = 36
IP_LOCATIONS[BROADCAST13_IP] = 37
IP_LOCATIONS[BROADCAST14_IP] = 38
IP_LOCATIONS[BROADCAST15_IP] = 39
IP_LOCATIONS[BROADCAST16_IP] = 40
IP_LOCATIONS[BROADCAST17_IP] = 41
IP_LOCATIONS[BROADCAST18_IP] = 42
IP_LOCATIONS[BROADCAST19_IP] = 43
IP_LOCATIONS[BROADCAST20_IP] = 44
...
POLICIES.append("*:Broadcast3->FW2->Zones")
POLICIES.append("dst_port=1433:Broadcast3->COUNTER2->Admins")
POLICIES.append("*:Broadcast4->FW2->Zones")
POLICIES.append("dst_port=1433:Broadcast4->COUNTER2->Admins")
POLICIES.append("*:Broadcast5->FW2->Zones")
POLICIES.append("dst_port=1433:Broadcast5->COUNTER2->Admins")
POLICIES.append("*:Broadcast6->FW2->Zones")
POLICIES.append("dst_port=1433:Broadcast6->COUNTER2->Admins")
POLICIES.append("*:Broadcast7->FW2->Zones")
POLICIES.append("dst_port=1433:Broadcast7->COUNTER2->Admins")
POLICIES.append("*:Broadcast8->FW2->Zones")
POLICIES.append("dst_port=1433:Broadcast8->COUNTER2->Admins")
POLICIES.append("*:Broadcast9->FW2->Zones")
POLICIES.append("dst_port=1433:Broadcast9->COUNTER2->Admins")
POLICIES.append("*:Broadcast10->FW->Zones")
POLICIES.append("dst_port=80:Broadcast10->COUNTER->Admins")
POLICIES.append("*:Broadcast11->FW->Zones")
POLICIES.append("dst_port=80:Broadcast11->COUNTER->Admins")
POLICIES.append("*:Broadcast12->FW->Zones")
POLICIES.append("dst_port=80:Broadcast12->COUNTER->Admins")
POLICIES.append("*:Broadcast13->FW->Zones")
POLICIES.append("dst_port=80:Broadcast13->COUNTER->Admins")
POLICIES.append("*:Broadcast14->FW->Zones")
POLICIES.append("dst_port=80:Broadcast14->COUNTER->Admins")
POLICIES.append("*:Broadcast15->FW->Zones")
POLICIES.append("dst_port=80:Broadcast15->COUNTER->Admins")
POLICIES.append("*:Broadcast16->FW->Zones")
POLICIES.append("dst_port=80:Broadcast16->COUNTER->Admins")
POLICIES.append("*:Broadcast17->FW->Zones")
POLICIES.append("dst_port=80:Broadcast17->COUNTER->Admins")
POLICIES.append("*:Broadcast18->FW->Zones")
POLICIES.append("dst_port=80:Broadcast18->COUNTER->Admins")
POLICIES.append("*:Broadcast19->FW->Zones")
POLICIES.append("dst_port=80:Broadcast19->COUNTER->Admins")
POLICIES.append("*:Broadcast20->FW->Zones")
POLICIES.append("dst_port=80:Broadcast20->COUNTER->Admins")
"""

ADDITIONAL_POLICIES = []
ADDITIONAL_POLICIES.append("dst_port=80:!Broadcast->SPECIAL_COUNTER->SpecialAdmins")
ADDITIONAL_POLICIES.append("dst_port=80:!Broadcast2->SPECIAL_COUNTER->SpecialAdmins")
ADDITIONAL_POLICIES.append("dst_port=80:!Broadcast3->SPECIAL_COUNTER->SpecialAdmins")
ADDITIONAL_POLICIES.append("dst_port=80:!Broadcast4->SPECIAL_COUNTER->SpecialAdmins")
ADDITIONAL_POLICIES.append("dst_port=80:!Broadcast5->SPECIAL_COUNTER->SpecialAdmins")
ADDITIONAL_POLICIES.append("dst_port=80:!Broadcast6->SPECIAL_COUNTER->SpecialAdmins")
ADDITIONAL_POLICIES.append("dst_port=80:!Broadcast7->SPECIAL_COUNTER->SpecialAdmins")
ADDITIONAL_POLICIES.append("dst_port=80:!Broadcast8->SPECIAL_COUNTER->SpecialAdmins")
ADDITIONAL_POLICIES.append("dst_port=80:!Broadcast9->SPECIAL_COUNTER->SpecialAdmins")